...
test('Test index', () => {
    ...
    expect(AppBootstrapper).toHaveBeenCalledWith(
        ...
        LocationManager.mock.instances[0]
    )

    expect(LocationManager).toHaveBeenCalledTimes(1)
    expect(LocationManager).toHaveBeenCalledWith(window)

    expect(UrlManager).toHaveBeenCalledTimes(1)
    expect(UrlManager).toHaveBeenCalledWith(UrlParser.mock.instances[0], LocationManager.mock.instances[0])
